...
bool AlCaDiJetsProducer::select (reco::PhotonCollection ph, reco::PFJetCollection jt) {
...
void AlCaDiJetsProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if (!pho.isValid()) {
    edm::LogWarning("AlCaDiJets") << "AlCaDiJetsProducer: Error! can't get the product " << labelPhoton_;
    return ;
  }
  ...
  if (!pfmt.isValid()) {
    edm::LogWarning("AlCaDiJets") << "AlCaDiJetsProducer: Error! can't get product " << labelPFMET_;
    return ;
  }
  ...
  if (!trig.isValid()) {
    edm::LogWarning("AlCaDiJets") << "AlCaDiJetsProducer: Error! can't get product " << labelTrigger_;
    return ;
  }
  ...
  if (!rh.isValid()) {
    edm::LogWarning("AlCaDiJets") << "AlCaDiJetsProducer: Error! can't get product " << labelRho_;
    return ;
  }
  ...
  if (!gsf.isValid()){
    edm::LogWarning("AlCaDiJets") << "AlCaDiJetsProducer: Error! can't get product " << labelGsfEle_;
    return ;
  }
  ...
  if (!con.isValid()){
    edm::LogWarning("AlCaDiJets") << "AlCaDiJetsProducer: Error! can't get product " << labelConv_;
    return ;
  }
  ...
  if (!bs.isValid()){
    edm::LogWarning("AlCaDiJets") << "AlCaDiJetsProducer: Error! can't get product " << labelBeamSpot_;
    return ;
  }
