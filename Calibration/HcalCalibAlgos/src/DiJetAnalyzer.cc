...
void DiJetAnalyzer::beginJob()
{
  ...
  tree_->Branch("pf_thirdjet_px_uncorr",&pf_thirdjet_px_uncorr_, "pf_thirdjet_px_uncorr/F");
  tree_->Branch("pf_thirdjet_py_uncorr",&pf_thirdjet_py_uncorr_, "pf_thirdjet_py_uncorr/F");
